...
env DEV=NV BEAM=1 JIT=2 KERNEL_HIST=1 MEASURE_N=50 ~/tg311/bin/python -u kern_hist.py > ~/tinygrad-metal/stage_kern.log 2>&1
echo "KERN_EXIT=$?" >> ~/tinygrad-metal/stage_kern.log
...
echo ALL_DONE > ~/tinygrad-metal/stage_p0.done
