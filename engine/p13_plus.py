...
# ================= P13 appended: my minimal iso-A test =================
...
dev.synchronize()
print("[p13] bufs up", flush=True)
_pr13 = prog("pfg3_ffn_r7_m32_nw8k128")
_pr13(P.d["r_fg"], P.d["r_fu"], P.d["gridf"], P.d["x32p"], P.d["o32p"], global_size=(272, 1, 1), local_size=LS)
dev.synchronize()
print("[p13] appended A CLEAN", flush=True)
