...
def V(tag, xb, ob, two=True):
  pr7(P.d["r_fg"], P.d["r_fu"], P.d["gridf"], xb, ob, global_size=(272, 1, 1), local_size=LS)
  if two: pr7(P.d["r_fg"], P.d["r_fu"], P.d["gridf"], xb.offset(offset=32*5120*2, size=32*5120*2), ob.offset(offset=32*17408*2, size=32*17408*2), global_size=(272, 1, 1), local_size=LS)
  dev.synchronize(); print(f"[V] {tag} CLEAN", flush=True)
V("V0-p7b-bufs-2launch", P.d["xffn"], P.d["mineffn"])
V("V1-p7b-bufs-1launch", P.d["xffn"], P.d["mineffn"], two=False)
...
dev.synchronize()
V("V2-fresh64-2launch", P.d["x64p"], P.d["o64p"])
V("V3-fresh64-1launch", P.d["x64p"], P.d["o64p"], two=False)
P.up("x32p", (np.random.default_rng(7).standard_normal((32, 5120)) * 0.8).astype(np.float16).reshape(-1))
P.poison("o32p", 32 * 17408, np.float16, 7.7)
dev.synchronize()
V("V4-fresh32-1launch", P.d["x32p"], P.d["o32p"], two=False)
