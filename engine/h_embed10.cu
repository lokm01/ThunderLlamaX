    ...
    float* __restrict__ x4)
{
  ...
  const int toks[10] = { min(max(s0[0], 0), VOCAB - 1), min(max(s1[0], 0), VOCAB - 1), min(max(s2[0], 0), VOCAB - 1), min(max(s3[0], 0), VOCAB - 1), min(max(s4[0], 0), VOCAB - 1), min(max(s5[0], 0), VOCAB - 1), min(max(s6[0], 0), VOCAB - 1), min(max(s7[0], 0), VOCAB - 1), min(max(s8[0], 0), VOCAB - 1), min(max(s9[0], 0), VOCAB - 1) };
  {
